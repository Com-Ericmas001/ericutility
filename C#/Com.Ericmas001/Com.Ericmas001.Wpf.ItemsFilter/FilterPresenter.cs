using Com.Ericmas001.Wpf.ItemsFilter.Initializer;
    ...
    public sealed class FilterPresenter : DependencyObject {
       ...
       // <summary>
        ...
        private FilterPresenter(ICollectionView source) {
            ...
            IItemProperties props = source as IItemProperties;
            filteredEventArgs = new FilteredEventArgs(source);
            itemProperties = props == null ? null : props.ItemProperties;
            ...
            public void Dispose() {
                if (!isDisposed) {
                    ...
                    if (filterPr.itemsDeferRefreshCount <= 0) {
                        ...
                        if (filterPr.CollectionView.CanFilter)
                        {
